                            ...
                            <div class="card">
                                ...
                                <div class="card-body p-0">
                                    <div class="col-lg-6 offset-lg-3">
                                        <form action="/admin/create-author" method="post" enctype="multipart/form-data">
                                            {{@csrf_field()}}
                                            <div class="card-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea id="description" rows='4' name="author_description" class="form-control" placeholder="Describe About Author"></textarea>
